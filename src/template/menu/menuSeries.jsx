...
import { faPlus, faList, faVideo, faTv } from '@fortawesome/free-solid-svg-icons';
...
export default function MenuSeries({ lastMovieTag }) {
    ...
    const tableData = 'Séries';

    return (
        <>
            <Card bg="dark" text="white" border="info">
                <Card.Header>
                    {titulo_secao.serie.titulo}<FontAwesomeIcon icon={faTv} className="Icon-Menu" />
                </Card.Header>
                <Card.Img variant="bottom" src={titulo_secao.serie.imagem} />
                <Card.Body>
